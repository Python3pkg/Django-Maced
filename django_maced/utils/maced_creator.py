...
def add_item_to_context(context, item_name, item_html_name, item_class, item_name_field_name, field_list,
    ...
    html_code_dictionary[item_name]["merge"] = \
        '<table class="table table-striped">' + \
            '<tr>' + \
                '<td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td>' + \
                '<td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>WhatIsThis</td><td>' + \
